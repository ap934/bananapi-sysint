...
case $SELFHEAL_TYPE in
    "BASE")
        ...
        CM_INTERFACE=`sysevent get current_wan_ifname`
	if [ "$CM_INTERFACE" = "" ]
        then
...
resetNeeded()
{
    ...
    then
        ...
        then
	       ...
	       modelName=`getModelName`
	       CMMac=`getCMMac`
	       echo_t "RDKB_SELFHEAL : <$level>Ethwan Gateway[$vendor]:<99000007><$timestamp><$CMMac><$modelName> RM $ProcessName process not running , restarting it"
            fi
            ...
            if [ "$SELFHEAL_TYPE" = "BASE" ] && [ "$ProcessName" == "snmp_subagent" ]
            then
                case $SELFHEAL_TYPE in
                    "BASE")
            ...
            elif [ "$SELFHEAL_TYPE" = "BASE" ] && [ "$ProcessName" == "CcspPandMSsp" ]
            then
                echo_t "RDKB_SELFHEAL : Resetting process $ProcessName"
                cd /usr/ccsp/pam/
		...
		cd -
            ...
            elif [ "$SELFHEAL_TYPE" = "BASE" ] && [ "$ProcessName" == "CcspLMLite" ]
            then
                echo_t "RDKB_SELFHEAL : Resetting process $ProcessName"
                cd /usr/ccsp/lm
            ...
            elif [ "$SELFHEAL_TYPE" = "BASE" ] && [ "$ProcessName" == "OneWifi" ]
            then
                echo_t "RDKB_SELFHEAL : Resetting process $ProcessName"
                cd /usr/ccsp/wifi
                $BINPATH/$ProcessName -subsys $Subsys
            ...
            elif [ "$SELFHEAL_TYPE" = "BASE" ] && [ "$ProcessName" == "CcspXdnsSsp" ]
            then
                echo_t "RDKB_SELFHEAL : Resetting process $ProcessName"
                cd /usr/ccsp/xdns
                $BINPATH/$ProcessName -subsys $Subsys
            ...
            elif [ "$SELFHEAL_TYPE" = "BASE" ] && [ "$ProcessName" == "CcspEthAgent" ]
            then
                echo_t "RDKB_SELFHEAL : Resetting process $ProcessName"
            ...
            elif [ "$SELFHEAL_TYPE" = "BASE" ] && [ "$ProcessName" == "PsmSsp" ]
            then
                echo_t "RDKB_SELFHEAL : Resetting process $ProcessName"
                cd /usr/ccsp
            ...
            elif [ "$SELFHEAL_TYPE" = "BASE" ] && [ "$ProcessName" == "CcspTandDSsp" ]
            then
                echo_t "RDKB_SELFHEAL : Resetting process $ProcessName"
